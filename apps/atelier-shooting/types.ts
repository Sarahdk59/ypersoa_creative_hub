...
// YP013 = Casquette Vintage (PRODUIT COIFFE — porté sur la tête, broderie sur le devant de la calotte,
//         pas côté cœur ; le moteur bascule en branche 'coiffe' via isHeadwear()).
export type ProductType = 'YP001' | 'YP004' | 'YP005' | 'YP019' | 'YP021' | 'YP022' | 'YP023' | 'YP013';
