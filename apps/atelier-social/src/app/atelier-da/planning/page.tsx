...
/**
 * Planning commun créa / prod / comm — Atelier DA.
...
import { ArrowLeft, Loader2, CalendarClock, Plus, Trash2, List, BarChart3, X } from "lucide-react";
import type {
...
export default function PlanningCommunPage() {
  ...
  return (
    <div style={{ maxWidth: 1180, margin: "0 auto" }}>
      <Link href="/atelier-da" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--font-sans)", fontSize: 12, color: "var(--hub-foreground)", opacity: 0.6, textDecoration: "none" }}>
        <ArrowLeft size={14} /> Atelier DA
      </Link>

      <header style={{ margin: "16px 0 20px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
          <CalendarClock size={26} strokeWidth={1.4} color="var(--hub-foreground)" />
          <h1 style={{ fontFamily: "var(--font-editorial)", fontSize: 34, fontWeight: 500, margin: 0, letterSpacing: "-0.015em" }}>Planning commun</h1>
        </div>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: 13.5, color: "var(--hub-foreground)", opacity: 0.7, lineHeight: 1.6, maxWidth: 720 }}>
