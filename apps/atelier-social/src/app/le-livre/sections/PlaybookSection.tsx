...
/**
 * Le Playbook — le rythme, fusionné dans Le Livre le 21/08/2026.
 * Ex-app/social/playbook/page.tsx. Rend le contenu de
 * docs/FICHES_RECETTES_ATELIER_SOCIAL.md : mêmes tokens que la section
 * Visuel (marine/teal/crème/rouge coquelicot), même grammaire de composants.
 *
 ...
 *
 * Note ouverte (21/08/2026) : le test « mojito » (Menthe/Citron vert/Rhum/
 * Sucre/Bulles) ci-dessous est un système de ton antérieur au thermostat
...
export function PlaybookSection() {
  ...
  return (
    <div className="text-brand-text font-sans">
      <header className="mx-auto max-w-[1100px] pb-0">
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", color: MARINE, fontFamily: SANS, padding: "32px 24px 80px" }}>
        ...
        <p style={{ fontSize: 12, color: "#8a8f96", marginTop: 8, lineHeight: 1.5, marginBottom: 0 }}>
          Source : <code>docs/FICHES_RECETTES_ATELIER_SOCIAL.md</code>. Même épine dorsale, même règles que la section Visuel — appliquées au calendrier Instagram.
        </p>
      </main>
