...
// ── Système visuel · v1.1 · 2026 ──────────────────────────────────────────────
// Ex-Brand Book (app/brand/page.tsx), fusionné dans Le Livre le 21/08/2026 :
// "on fusionne tout, une source unique, tous les documents et les apps
// regardent dans la même direction". Reste la référence pour les tokens
// visuels exacts (couleurs, typo, funnel, rubriques) — voir §3 du Livre.
...
const RUBRIQUES = [
  ...
  { emoji: "✂️", label: "Coulisses atelier", format: "Reel / Carrousel 4:5", freq: "1×/sem", ex: "Macro du fil qui rentre dans l'aiguille.", tone: "Atelier réel, précis" },
...
const VOCAB_OK = [
  ...
  "cousu pour durer",
  "personnalisé (SEO uniquement)",
  "vêtements à ton image",
  "Hauts-de-France",
  "brodé à ton prénom / ton mot",
  "brodé pour toi",
];

const VOCAB_NON = [
  "Made in France / fabriqué en France / brodé en France",
  "brodé à la main / fait main / artisanal(e)",
  "Tajima hors des 3 contextes autorisés (Le Livre §4)",
      ...
      <Section title="10 · Les garde-fous" sub="Verrouillés. En cas de doute entre « joli » et « conforme » : les garde-fous gagnent.">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <GuardCard tone="no" items={[
            ...
            "Tajima hors contexte savoir-faire/process/backend (Le Livre §4)",
            "Cormorant · DM Sans (dépréciées)",
  ...
  "rules": {
    ...
    "external_links": "ypersoa.fr uniquement"
      ...
      <p style={{ fontSize: 12, color: "#8a8f96", marginTop: 8, lineHeight: 1.5, marginBottom: 48 }}>
        Cette section fait foi pour les tokens visuels exacts (couleurs, typo, funnel, rubriques).
      </p>
    </div>
  );
}
