...
export default function EpisodeDetailPage({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      window.location.href = "/studio/studio-mood";
    } catch (e) {
      alert(e instanceof Error ? e.message : String(e));
      setDeleting(false);
    }
  ...
  if (error || !ep) return (
    <div style={{ padding: 32 }}>
      <Link href="/studio/studio-mood" style={backLinkStyle}><ArrowLeft size={14} /> Studio Mood</Link>
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      <Link href="/studio/studio-mood" style={backLinkStyle}>
      ...
      <header style={{ marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12, flexWrap: "wrap" }}>
          ...
          <Link href={`/studio/studio-mood/${id}/edit`} style={secondaryBtnStyle}>
