      ...
      <div className="flex items-center bg-hub-bg-alt rounded-full p-0.5 border border-hub-border w-fit mb-4">
        <button
          ...
          className={cn(
            ...
            tab === "legende" ? "bg-white text-hub-ocre shadow-sm" : "text-hub-foreground/55 hover:text-hub-foreground"
          )}
        >
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold transition-all",
            tab === "visuel" ? "bg-white text-hub-ocre shadow-sm" : "text-hub-foreground/55 hover:text-hub-foreground"
          )}
        >
