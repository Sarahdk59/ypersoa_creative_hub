...
function detectOccasion(brief: string): string | null {
  ...
  const map: Array<[RegExp, string]> = [
    ...
    // Fêtes calendaires
    [/\b(f[êe]te.*grand[\s-]m[èe]res?|mamies?|grand[\s-]m[èe]res?)\b/i, "fete-grand-meres"],
    [/\b(f[êe]te.*grand[\s-]p[èe]res?|papis?|grand[\s-]p[èe]res?)\b/i, "fete-grand-peres"],
    [/\b(f[êe]te.*m[èe]res?|mothers?|mamans?)\b/i, "fete-meres"],
    [/\b(f[êe]te.*p[èe]res?|fathers?|papas?)\b/i, "fete-peres"],
